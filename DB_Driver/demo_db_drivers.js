var drivers = require('./');  // contain all database drivers
const config = {
    host: "localhost",
    user: "traffic",
    password: "12345",
...
/*********** MySQL Demo **********/
var mysql = drivers.mysql_driver;  // MySQL driver
...
/*
var maria = drivers.mariadb_driver;  // MariaDB driver
...
var postgres = drivers.postgres_driver;
...
/*
var sqlserver = drivers.sqlserver_driver;
...
/*
var oracle = drivers.oracle_driver;
